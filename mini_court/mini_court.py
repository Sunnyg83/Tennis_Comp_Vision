...
class MiniCourt():
    ...
    def set_court_drawing_key_points(self):
        ...
        # 4th point 
        drawing_key_points[8] = drawing_key_points[0] +  self.convert_meters_to_pixels(constants.DOUBLES_ALLEY_DIFFERENCE)
        drawing_key_points[9] = drawing_key_points[1] 
        # 5th point 
        drawing_key_points[10] = drawing_key_points[4] + self.convert_meters_to_pixels(constants.DOUBLES_ALLEY_DIFFERENCE)
        drawing_key_points[11] = drawing_key_points[5] 
        # 6th point 
        drawing_key_points[12] = drawing_key_points[2] - self.convert_meters_to_pixels(constants.DOUBLES_ALLEY_DIFFERENCE)
        drawing_key_points[13] = drawing_key_points[3] 
        # 7th point 
        drawing_key_points[14] = drawing_key_points[6] - self.convert_meters_to_pixels(constants.DOUBLES_ALLEY_DIFFERENCE)
...
# top left edge
    ...
    def draw_background_rect(self, frame):
        ...
        # Draw rectangle
        cv2.rectangle(shapes, (self.start_x, self.start_y), (self.end_x, self.end_y), (255, 255, 255), -1) # -1 represents filled
        out = frame.copy()
        alpha=0.5
    ...
    # above only draws on one frame 


    def draw_court(self,frame):

        # keypoints on mini court
    ...
    def get_mini_court_coordinates(self,
        ...
        # Convert to the mini court coordinates
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self,player_boxes, ball_boxes, original_court_key_points ):
        ...
        6: constants.PLAYER_6_HEIGHT_METERS
        }
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            for player_id, bbox in player_bbox.items():
                ...
                # Get The closest keypoint to player in pixels (0,2,12,13)
                ...
                frame_index_max = min(len(player_boxes), frame_num+50) # 50 frames accounts for if player is bent in n frames
    ...
    # used to convert bb cooredinates to orginal court to mini court
