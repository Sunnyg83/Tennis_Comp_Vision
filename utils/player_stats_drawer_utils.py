...
def draw_player_stats(output_video_frames,player_stats):
    ...
    for index, row in player_stats.iterrows():
        player_6_shot_speed = row['player_6_latest_shot_speed']
        player_2_shot_speed = row['player_2_latest_shot_speed']
        player_6_speed = row['player_6_latest_player_speed']
        player_2_speed = row['player_2_latest_player_speed']

        avg_player_6_shot_speed = row['player_6_average_shot_speed']
        avg_player_2_shot_speed = row['player_2_average_shot_speed']
        avg_player_6_speed = row['player_6_average_player_speed']
        ...
        text = f"{player_6_shot_speed:.1f} mph    {player_2_shot_speed:.1f} mph"
        ...
        text = f"{player_6_speed:.1f} mph    {player_2_speed:.1f} mph"
        ...
        text = f"{avg_player_6_shot_speed:.1f} mph    {avg_player_2_shot_speed:.1f} mph"
        ...
        text = f"{avg_player_6_speed:.1f} mph    {avg_player_2_speed:.1f} mph"
